...
function isDataItem(data: any): data is DataItem {
...
export async function GET(req: NextRequest) {
    ...
    //     if (b.data) {
    //       const getData = b.data as DataItem
    //       if(getData !== undefined && getData.type === 'fetch'  && getData.value) {
    //         asyncData.push(b);
    //       }else {
    //         plainData.push({...b, data: getData.value});
    //       }
    //     }
    //   }
    //   // boardList.forEach(v => {
    //   //   if(v.data && v.data.type === 'fetch') {
    //   //     asyncData.push(v);
    //   //   }else {
    ...
    if (boardList) {
      for (let b of boardList) {
        if (b.data && isDataItem(b.data)) {
          if (b.data.type === 'fetch' && b.data.value) {
            asyncData.push(b);
          } else {
            plainData.push({ ...b, data: b.data.value });
          }
        }
      }
    }
